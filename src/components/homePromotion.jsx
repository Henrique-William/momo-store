...
export default function HomePromotion() {
  return (
    <section className='flex flex-col justify-center text-center items-center my-10 gap-4 px-40'>
      ...
      <div className='bg-dark w-full aspect-[21/9] rounded-2xl relative flex justify-center items-center cursor-pointer'><img src="images/icon/play.svg" alt="play button" className='absolute'/></div>
    </section>
  )
}
